...
//    (ggroup.pw ? '-p "' + ggroup.pw + '"' : ''),
    (ggroup.system ? '--system' : ''),
    (ggroup.gid ? '-g ' + ggroup.gid : ''),
    ggroup.name
  );
  delete ggroup.system;
...
/**
 * return a cleansed hash of values from the GGroup objects in Group
 * @returns {object} hash of groups, cleansed of GGroup methods etc
 */
Group.prototype.$cleansed = function () {
  var ggroup = new GGroup();
